...
**Location:** `docs/specs/serviceRequest_status/service_request_status_technical_spec.md`  
...
ALTER TABLE service_requests ADD COLUMN IF NOT EXISTS notification_dispatched_at TIMESTAMP WITHOUT TIME ZONE DEFAULT NULL;
